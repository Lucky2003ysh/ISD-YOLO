...
from ultralytics.nn.attention.gam_cbam import *
from ultralytics.nn.Conv.SPD_Conv import space_to_depth, ELSPDConv
from ultralytics.nn.Conv.P_SPD_Conv import LightP_SPD_Conv
from ultralytics.nn.Conv.LSCMDC import LSCMDC
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolo11n.yaml", ch=3, nc=None, verbose=True):
        ...
        if isinstance(m, Detect):  # includes all Detect subclasses like Segment, Pose, OBB, YOLOEDetect, YOLOESegment
            ...
            m.stride = torch.tensor([s / x.shape[-2] for x in _forward(torch.zeros(1, ch, s, s))])  # forward//原来为1
